...
bananagrams: main.o tile.o hand.o grid.o buffer.o message.o control.o
	$(CXX) $(CXXFLAGS) -o bananagrams main.o tile.o hand.o grid.o buffer.o message.o control.o -lsfml-graphics -lsfml-window -lsfml-system
...
buffer.o: buffer.cpp buffer.hpp tile.hpp grid.hpp hand.hpp
